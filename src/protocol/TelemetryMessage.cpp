...
std::string buildTelemetryJson(const BringupTelemetry& telemetry)
{
    ...
    if (telemetry.mission.present) {
        ...
        message["mission"] = {
            ...
            {"return_active", telemetry.mission.return_active},
            {"return_phase", telemetry.mission.return_phase},
            {"grid_map_finalized", telemetry.mission.grid_map_finalized},
            {"grid_pose_visible", telemetry.mission.grid_pose_visible},
            {"vertiport_return_active", telemetry.mission.vertiport_return_active},
            {"vertiport_acquired", telemetry.mission.vertiport_acquired},
            {"landing_success", telemetry.mission.landing_success},
            {"mission_complete", telemetry.mission.mission_complete},
